...
def get_dashboard(db: Session = Depends(get_db)):
    ...
    terminal_stages = {"rejected", "archived", "ghosted", "offer_verbal", "offer_written"}
    ...
    terminal_stages_stale = {"rejected", "withdrawn", "archived", "ghosted", "offer_verbal", "offer_written"}
...
def get_funnel(
    ...
    terminal_stages = {"Rejected", "Withdrawn", "Archived", "Ghosted", "Interested", "Applying", "Offer"}
